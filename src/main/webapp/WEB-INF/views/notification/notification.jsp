						...
						<div class="col-sm-9 mail_view">
							<div class="inbox-body">
								<div class="mail_heading row">
									...
									<p class="date">${notificationRead.hours}:
									${notificationRead.munite} PM ${notificationRead.day} ${notificationRead.month}</p>
									</div>
									<div class="col-md-12">
								...
								<div class="sender-info">
									<div class="row">
										<div class="col-md-12">
											<strong></strong>${notificationRead.users.username} <span>(${notificationRead.users.email} )</span> to
								...
								<div class="view-mail">
									<p>${notificationRead.description }</p>
								</div>
