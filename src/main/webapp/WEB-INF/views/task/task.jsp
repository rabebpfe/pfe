			...
			<div class="x_panel">
				...
				<div class="x_content">
					<form:form id="demo-form2" class="form-horizontal form-label-left"
						modelAttribute="task" method="POST" action="saveTask">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:textarea path="description" id="Task_Description"
									name="Task_Description" class="form-control col-md-7 col-xs-12" />
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:select path="priorite" class="form-control">
									<form:option path="priorite" value="Low" />
									<form:option path="priorite" value="Midium" />
									<form:option path="priorite" value="High" />
